...
public class invalid_reg1 {
  ...
  public void f() throws BiffException, IOException {
	    ...
	    String endpoint = j.readexcel(7,18);
	    System.out.println(endpoint);
	    String email = j.readexcel(4,18);
	    System.out.println(email);
	    String password = j.readexcel(5,18);
	    System.out.println(password);  	      
	      String jsonString = "{\n"
	          ...
	          {
	              j.writexcel("TestCase",10, 21, "passed");
	          }
	          
	          else
	          {
	              j.writexcel("TestCase",10, 21, "failed");
	          }
}
}
