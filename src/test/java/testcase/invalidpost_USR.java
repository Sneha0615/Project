...
public class invalidpost_USR {
  ...
  public void f() throws BiffException, IOException {
	    ...
	    String endpoint = j.readexcel(7,12);
	    System.out.println(endpoint);
	    String email = j.readexcel(4,12);
      ...
      {
          j.writexcel("TestCase",10, 15, "passed");
      }
      else
      {
          j.writexcel("TestCase",10, 15, "failed");
      }
}
}
